...
const spreadsheetId = '1K9q7edqNhITaZYAZjTHqTBNwyVVU1ovKgugG0ZXrVkE';
    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            const response = await sheets.spreadsheets.values.get({
                spreadsheetId,
                range: 'Sheet1!A:E', // Date | Email | Country | State | City
            });
            ...
            const mailOptions = {
                ...
                to: ["ayushahirwar6673@gmail.com"], // Your notification email
                subject: `New Brochure Request – Allastir Private Limited`,
                html: `
                    <div style="font-family: Arial, sans-serif; color: #333; padding: 20px 0;">
                        <h2 style="color: #000; font-size: 18px; margin-bottom: 10px;">
                            New Brochure Request – Allastir Private Limited
                        </h2>
                        <hr />
                        <ul>
                        ...
                        <hr />
                        <p>Regards,</p>
                        <p><b>Automated Brochure System</b></p>
