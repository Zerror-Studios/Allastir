    ...
    <div className="w-full min-h-screen flex sm:flex-col md:flex-col lg:flex-col sm:gap-[6vw] md:gap-[6vw] lg:gap-[6vw] gap-[1vw] items-center p-[2.5vw] sm:pt-[35vw] md:pt-[20vw] lg:pt-[15vw] sm:px-[4vw] md:px-[4vw] lg:px-[4vw] pt-[5.5vw]">
      <div className="sm:w-full md:w-full lg:w-full w-[50%] sm:h-fit md:h-fit h-[85vh] sm:bg-transparent md:bg-transparent bg-zinc-100/40 rounded-2xl sm:p-0 md:p-0 p-[2.5vw] flex flex-col justify-between">
        <div className="w-full">
          <h1 className="sm:font-semibold sm:text-[7vw] md:text-[5vw] text-[3vw] sm:mb-[3vw] capitalize leading-none">
            Contact us
          </h1>
          <p className="sm:text-[4.5vw] md:text-[3vw] lg:text-[2.2vw] sm:w-full md:w-full text-[1vw] w-[80%] sm:my-[4.5vw] md:mt-[2vw] md:mb-[4vw] lg:my-[4.5vw] my-[1vw] leading-1">
        ...
        <form
          ...
          className="w-full mt-[1.5vw] sm:mt-[0] md:mt-[0] flex flex-col sm:gap-[3vw] md:gap-[3vw] gap-[1vw] sm:text-[3.8vw] md:text-[2.5vw]"
        >
          {/* SUCCESS MESSAGE */}
          {/* SUCCESS MESSAGE */}
          {successMessage && (
          ...
          <div className="w-full flex flex-col">
            ...
            <input
              ...
              className="w-full p-[1.5vw] sm:py-[2.5vw] md:py-[1vw] lg:py-[1.5vw] sm:px-[2vw] md:px-[2vw] py-[.6vw] border border-black/20 rounded-md bg-transparent"
              type="text"
              placeholder="Name"
            />
          </div>
          ...
          <div className="w-full flex flex-col">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full resize-none sm:h-[18vw] md:h-[18vw] lg:h-[18vw] h-[7vw] p-[1.5vw] sm:py-[2.5vw] md:py-[1vw] lg:py-[1.5vw] sm:px-[2vw] md:px-[2vw] py-[.6vw] border border-black/20 rounded-md bg-transparent"
          ...
          <div className="w-full flex items-center justify-center sm:h-[7vw] md:h-[6vw] lg:h-[10vw] h-[4vw] sm:mt-[2vw] md:mt-[2vw]">
            <button
              className="text-white bg-black w-full text-center capitalize px-[1.5vw] transition-all duration-500 cursor-pointer sm:py-[4vw] md:py-[1.5vw] lg:py-[2vw] xl:py-[1.5vw] py-[.6vw] rounded-full font-semibold"
              disabled={isLoading}
            >
              {isLoading ? (
                ...
                <h4 className="sm:text-[3.5vw] md:text-[2.5vw] lg:text-[3vw] xl:text-[1.8vw] text-[1.1vw] font-normal">
                  Submit
                </h4>
              )}
            </button>
      ...
      <div className="sm:w-full md:w-full lg:w-full w-[50%] sm:h-fit md:h-fit h-[85vh] sm:gap-[6vw] md:gap-[6vw] gap-[1vw] rounded-2xl flex flex-col sm:pt-[4vw]">
        ...
        <div className="w-full h-[50%] rounded-2xl overflow-hidden sm:p-0 md:p-0 p-[1.2vw] bg-zinc-100/40 flex sm:flex-col justify-between items-center">
          <Image
            className="sm:w-full md:w-[48%] w-[56%] h-full rounded-xl object-cover"
            width={1000}
            height={1000}
            priority
            src="/unit1.png"
            alt="unit-image"
          />
          <div className="sm:hidden md:w-[48%] md:py-4  w-[41%] h-fit">
            <h4 className="text-[2.5vw] font-semibold">Unit 1</h4>
            <a target="_blank" className="text-[2vw] text-black/70">
             ...
             <p className="text-[2vw] mt-[0.5vw]">
              <a href="tel:+91-97910 39207">
                <span className="text-[1vw] md:text-[2vw] font-semibold">E-Mail :</span>{" "}
                <span className="text-black/70"> <a href="mailto:sales@allastir.com">sales@allastir.com</a></span>
              </a>
            </p>
            <p className="text-[2vw]">
              <a href="tel:+91-97910 39207">
                <span className="text-[1vw] font-semibold md:text-[2vw]">Mobile No. :</span>{" "}
                <span className="text-black/70">+91-97910 39207</span>
              </a>
            </p>
            <p className="text-[2vw]">
              <a href="tel:+91-98400 51621">
                <span className="text-[1vw] font-semibold md:text-[2vw]">
                  Telephone No. :
                </span>{" "}
        ...
        <div className="w-full h-[50%] rounded-2xl overflow-hidden sm:p-0 md:p-0 p-[1.2vw] bg-zinc-100/40 flex sm:flex-col justify-between items-center">
          ...
          />
          <div className="sm:hidden md:w-[48%] md:py-4 w-[41%] h-fit">
            <h4 className="text-[1vw] md:text-[2.5vw] font-semibold">Unit 2</h4>
            <a target="_blank" className="text-[1.05vw] md:text-[2vw] text-black/70">
           ...
           <p className="text-[1.05vw] md:text-[2vw] mt-[0.5vw]">
              <a href="tel:+91-97910 39207">
                <span className="text-[1vw] font-semibold md:text-[2vw]">E-Mail :</span>{" "}
                <span className="text-black/70"> <a href="mailto:sales@allastir.com">sales@allastir.com</a></span>
              </a>
            </p>
            <p className="text-[1.05vw] md:text-[2vw]">
              <a href="tel:+91-97910 39207">
                <span className="text-[1vw] font-semibold md:text-[2vw]">Mobile No. :</span>{" "}
                <span className="text-black/70">+91-97910 39207</span>
              </a>
