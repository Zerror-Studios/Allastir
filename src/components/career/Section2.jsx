...
const Section2 = ({ sec2Ref }) => {
  ...
  return (
    <>
      <div
        ref={sec2Ref}
        className="w-full min-h-screen sm:p-[20px] md:p-[4vw] sm:py-[10vw] p-[11%] py-[6vw] bg-white"
      >
        <h1 className="sm:font-semibold sm:text-[7vw] md:text-[5vw] text-[3vw] sm:mb-[3vw] capitalize leading-none">
          Careers at Allastir
        </h1>
        <p className="sm:text-[4.5vw] md:text-[3vw] lg:text-[2.2vw] sm:w-full md:w-full text-[1vw] w-[80%] sm:my-[4.5vw] md:mt-[2vw] md:my-[4vw] lg:my-[4.5vw] my-[1vw] leading-1">
        ...
        <div className="grid sm:grid-cols-1 grid-cols-2 sm:gap-[4vw] gap-[2vw]">
          {jobOpenings.map((job) => (
            ...
            >
              <div>
                <h2 className="text-[1.5vw] sm:text-[5vw] md:text-[2.5vw]  font-bold mb-2">
                  {job.position}
                </h2>

                <p className="text-zinc-700 text-[1vw] sm:text-[4vw] md:text-[2vw] ">
                  <strong>Experience:</strong> {job.experience}
                </p>

                <p className="text-zinc-700 text-[1vw] sm:text-[4vw] md:text-[2vw] mt-1">
              ...
              <button
                ...
                className="
          text-center sm:text-[12px] text-[14px] sm:py-[12px] md:py-[8px] py-[12px] sm:px-[20px]  px-[30px]
